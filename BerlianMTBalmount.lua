-- 👑 KING BERLIAN 👑 Teleport + Checkpoint Selector
-- by Cekiq
...
if CoreGui:FindFirstChild("KING_GUI") then
    CoreGui:FindFirstChild("KING_GUI"):Destroy()
end
...
Dropdown.Position = UDim2.new(0.1, 0, 0.55, 0)
Dropdown.BackgroundColor3 = Color3.fromRGB(255, 170, 0)
Dropdown.TextColor3 = Color3.fromRGB(0, 0, 0)
Dropdown.Font = Enum.Font.Gotham
Dropdown.TextSize = 18
Dropdown.Text = "Pilih Checkpoint"

ListFrame.Size = UDim2.new(0.8, 0, 0.4, 0)
ListFrame.Position = UDim2.new(0.1, 0, 0.75, 0)
...
Toggle.MouseButton1Click:Connect(function()
    ...
    Toggle.BackgroundColor3 = running and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(0, 0, 255)
    if running then
        task.spawn(startTeleport)
    end
end)
